...
export default function ServicesPage() {
  return (
    <main className="relative min-h-screen bg-[#010101] overflow-x-hidden">
      ...
      {/* Fixed noise texture */}
      <div className="fixed inset-0 z-[1] pointer-events-none opacity-[0.03] noise-overlay"
      ...
      <section className="relative w-full h-[100dvh] min-h-[600px] flex flex-col items-center justify-center text-center px-6">
        ...
        <motion.div
          ...
          className="absolute bottom-12 md:bottom-16 z-20 flex flex-col items-center gap-2 left-1/2 -translate-x-1/2"
        >
